...
**Posljednje ažurirano:** 17. ožujka 2026.
...
- [Komponentni pristup u Vue.js](#komponentni-pristup-u-vuejs)
    - [Primjer liste voća koristeći samo html](#primjer-liste-voća-koristeći-samo-html)
    - [Primjer liste voća koristeći html i js](#primjer-liste-voća-koristeći-html-i-js)
    - [Primjer liste voća koristeći Vue](#primjer-liste-voća-koristeći-vue)
    - [Primjer liste voća koristeći Vue i komponentu](#primjer-liste-voća-koristeći-vue-i-komponentu)
    - [Primjer liste voća i liste povrća koristeći Vue i komponente](#primjer-liste-voća-i-liste-povrća-koristeći-vue-i-komponente)
...
- [Prednosti Tailwinda](#prednosti-tailwinda)
    ...
    - [Lakše održavanje kôda](#lakše-održavanje-kôda)
...
2. **Instalacija Node.js**  
    - Potrebno je preuzet i instalirat Node.js verziju `>=24.14` s [nodejs.org](https://nodejs.org)
...
4. **Odabir naziva projekta**  
    ...
    - Taj naziv će odrediti ime mape u kojoj će se generirati svi potrebni resursi
        ...
        <img src="Slike/VueCreateName.png" style="height: 200px; border-radius: 8px; object-fit: contain;"></img>

5. **Podešavanje postavki projekta**  
    - U ovom koraku nije potrebno birati dodatne opcije, pa za sve stavke odabiremo `No`

        <img src="Slike/VueCreateTS.png" style="height: 50px; border-radius: 8px; object-fit: contain;"></img>
        
    - Kasnije, kada budemo koristili Router i Piniu, za te opcije ćemo odabrati da, u ovom slučaju ništa nećemo označiti

        <img src="Slike/VueCreateSettings.png" style="height: 180px; border-radius: 8px; object-fit: contain;"></img>

        <img src="Slike/VueCreateSettings2.png" style="height: 100px; border-radius: 8px; object-fit: contain;"></img>

    - Te odabrat ćemo `Yes` da preskočimo primjer kôda i dobijemo čisti kostur aplikacije, u suprotnom slučaju dobit ćemo nepotrebne datoteke i komponente koje ćemo kasnije morati ručno brisati.

        <img src="Slike/VueCreateExample.png" style="height: 50px; border-radius: 8px; object-fit: contain;"></img>


<div style="display: flex; flex-direction: column; justify-content: center;">
    <div style="text-align: center;"><i>Primjer cijelog procesa kreiranja projekta:</i></div>
    <img src="Slike/VueCreateProcess.png" style="height: 600px; border-radius: 8px; object-fit: contain;"></img>
</div>
...
<img src="./Slike/samostalni_zadatak_za_vježbu_1_primjer.png"
   style="width: 70%; height: auto; object-fit: cover; border-radius: 0.5rem;">
...
<div style="display: flex; gap: 1rem;">
   <img src="./Slike/samostalni_zadatak_za_vježbu_1_primjer_2.png"
     style="width: 69%; height: auto; object-fit: cover; border-radius: 0.5rem;">
   <img src="./Slike/samostalni_zadatak_za_vježbu_1_primjer_3.png"
     style="width: 28%; height: auto; object-fit: cover; border-radius: 0.5rem;">
</div>
